export default function Landing() {
    return (
        <div id="content" className="p-4 p-md-5 pt-5">
            <h2 className="mb-4">Welcome to FitHub</h2>
            <div>
                Welcome to FitHub, the ultimate fitness tracking app for achieving your health and fitness goals.
            </div>
            <div>
                With FitHub, you can easily track your daily activity, monitor your progress, and stay motivated to
                reach your goals.
            </div>
            <div>
