    ...
    return (
        <div className="centered1">
            <form onSubmit={submit}>
                ...
                <label className="labelItem">User Name</label><input placeholder={data.userName}
                                                                     onChange={(e) => setUserName(e.target.value)}></input><br/>

                <label className="labelItem">Date of Birth</label><input placeholder={data.dateOfBirth}
                                                                         onChange={(e) => setDateOfBirth(e.target.value)}></input><br/>

                <label className="labelItem">Height</label><input placeholder={data.height}
                                                                  onChange={(e) => setHeight(e.target.value)}></input><br/>

                <label className="labelItem">Weight</label><input placeholder={data.weight}
                                                                  onChange={(e) => setWeight(e.target.value)}></input><br/>
